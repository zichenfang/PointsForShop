//
//  PoinstHistoryListViewController.m
//  PointsForShop
//
//  Created by 殷玉秋 on 2017/11/22.
...
@interface PoinstHistoryListViewController ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation PoinstHistoryListViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (historyObj.isNullData == YES) {
        ...
        PointsHistoryTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:@"points"];
        if (cell == nil) {
            cell = [[NSBundle mainBundle] loadNibNamed:@"PointsHistoryTableViewCell" owner:self options:nil][0];
        }
