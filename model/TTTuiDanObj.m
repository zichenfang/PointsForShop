...
- (instancetype)initWithDic: (NSDictionary *)info{
    ...
    self.pay_time = [[info string_ForKey:@"pay_time"] doubleValue];
    self.pay_time_format = [[NSDate dateWithTimeIntervalSince1970:self.pay_time] formatTimeInyyyyMMddHHmmss];
